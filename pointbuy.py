def point_buy():
    point_buy = {7:-4, 8:-2, 9:-1, 10:0, 11:1, 12:2, 13:3, 14:5, 15:7, 16:10,
                 17:13, 18:17}
    ...
    while done != "0":
        ...
        if stat in ability_score:
            ...
            stat_point = point_buy[ability_score["strength"]] + point_buy[ability_score["dex"]] + point_buy[ability_score["con"]] + point_buy[ability_score["wis"]] + point_buy[ability_score["intelligence"]] + point_buy[ability_score["cha"]]
            if stat_point > 20:
                print("You're stats are to high, Try lowering some.")
                continue
        done = input("Are you finished? (Enter '0' to end or anything else to continue)")
